...
describe('getClosestPulse', function() {
  it('should throw the proper error with a bad timestamp', function() {
    return new Promise((resolve, reject) => {
      beacon
        ...
        .catch(err => {
          err.should.equal('Invalid timestamp')
          resolve()
        })
    })
  })
...
describe('getNextPulse', function() {
  it('should throw the proper error with a bad timestamp', function() {
    return new Promise((resolve, reject) => {
      beacon
        .getNextPulse('bad')
...
describe('getPreviousPulse', function() {
  it('should throw the proper error with a bad timestamp', function() {
    return new Promise((resolve, reject) => {
      beacon
        .getPreviousPulse('bad')
        .then(() => {
          reject('no error thrown')
        })
        .catch(err => {
  ...
  it('should return the expected value for the testTimestamp', function() {
    return new Promise((resolve, reject) => {
      beacon
        .getPreviousPulse(testTimestamp)
        .then(res => {
          res.should.have.property('pulse')
          res.pulse.should.have.property(
            'uri',
...
describe('getMostRecentPulse', function() {
...
describe('getPulseByChainAndPulseIndex', function() {
  it('should throw the proper error with a bad chainIndex', function() {
    return new Promise((resolve, reject) => {
      beacon
        .getPulseByChainAndPulseIndex('bad', 1)
        .then(() => {
          reject('no error thrown')
        })
        .catch(err => {
          err.should.equal('Invalid chainIndex')
          resolve()
        })
    })
  })
  it('should throw the proper error with a bad pulseIndex', function() {
    return new Promise((resolve, reject) => {
      beacon
        .getPulseByChainAndPulseIndex(1, 'bad')
        .then(() => {
          reject('no error thrown')
        })
        .catch(err => {
          err.should.equal('Invalid pulseIndex')
          resolve()
        })
    })
  })
